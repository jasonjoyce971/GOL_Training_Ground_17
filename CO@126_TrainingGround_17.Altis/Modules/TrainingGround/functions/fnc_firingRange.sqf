...
switch (toLower _action) do {
	...
	case (toLower "getRecruitDataIndex") : {
		...
		// Get the container
		private "_data";
		_data = ["getData", [_object]] call GW_TrainingGround_fnc_firingRange;
	...
	case (toLower "getRecruitData") : {
		...
		// The recruit data index
		private "_index";
		_index = ["getRecruitDataIndex", [_object, _uid]] call GW_TrainingGround_fnc_firingRange;
	...
	case (toLower "setRecruitData") : {
		...
		// Store
		["setData", [_object, _data]] call GW_TrainingGround_fnc_firingRange;
	};
	...
	case (toLower "addRecruitCourseData") : {
		...
		_recruitData = ["getRecruitData", [_object, _uid]] call GW_TrainingGround_fnc_firingRange;
		...
		if (count _recruitData > 0) then {
			...
			// Store
			["setRecruitData", [_object, _uid, _recruitData]] call GW_TrainingGround_fnc_firingRange;
		};
	};
	...
	case (toLower "getRecruitProperty") : {
		...
		// The recruit data
		private "_data";
		_data = ["getRecruitData", [_object, _uid]] call GW_TrainingGround_fnc_firingRange;
	...
	case (toLower "getRecruitName") : {
		...
		// Return
		["getRecruitProperty", [_object, _uid, INDEX_NAME, ""]] call GW_TrainingGround_fnc_firingRange;
	};
	...
	case (toLower "getRecruitCourses") : {
		...
		// Return
		["getRecruitProperty", [_object, _uid, INDEX_COURSES, []]] call GW_TrainingGround_fnc_firingRange;
	};
	...
	case (toLower "getRecruitBestCourse") : {
		...
		// The courses
		private "_courses";
		_courses = ["getRecruitCourses", [_object, _uid]] call GW_TrainingGround_fnc_firingRange;
	...
	case (toLower "uiOnLoad") : {
		...
		// Fill the list box
		["uiFillTable", [_object, _listBox]] call GW_TrainingGround_fnc_firingRange;
	};
	...
	case (toLower "uiFillTable") : {
		...
		
		{
			...
			private "_bestCourse";
			_bestCourse = ["getRecruitBestCourse", [_object, _uid]] call GW_TrainingGround_fnc_firingRange;
		...
		{
			// Fill list box row
			["uiFillTableRow", [_object, _listBox, _x]] call GW_TrainingGround_fnc_firingRange;
		} forEach _dataSorted;
