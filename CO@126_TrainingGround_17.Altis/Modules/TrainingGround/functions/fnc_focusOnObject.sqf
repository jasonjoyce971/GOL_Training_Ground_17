...
switch (toLower _action) do {
	case (toLower "initialize") : {
		...
		// PP
		["ppPlay"] call GW_TrainingGround_fnc_focusOnObject;
		...
		switch (toLower _type) do {
			...
			case (toLower "FiringRange") : { ["uiOpen", [_object]] call GW_TrainingGround_fnc_firingRange; };
		};
		...
		// Terminate
		["terminate"] call GW_TrainingGround_fnc_focusOnObject;
	};
